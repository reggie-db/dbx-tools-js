...
Pure-type package that holds the wire-format contracts shared between [`@dbx-tools/appkit-genie`](../genie) (server plugin) and [`@dbx-tools/appkit-genie-ui`](../genie-ui) (React component).
